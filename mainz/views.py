...
def daily_report_view(request):
    ...
    daily_rows = []
    totals_acc = {k: 0 for k in ['total', 'confirmed', 'non_confirmed', 'trip_still_confirmed',
    ...
    # breakdown[metric][car_type][age_key][repeat_key][pickup_div] -> list of daily ints
    metrics = ['total', 'confirmed', 'non_confirmed', 'completed', 'cancelled_from_confirmed', 'zero_bid']
    ...
    # Build daily_rows (original UI unchanged)
    ...
    # Chart payload: ensure JSON-serializable
    chart_payload = {
